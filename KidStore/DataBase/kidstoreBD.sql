CREATE DATABASE IF NOT EXISTS kidstoreBD;
USE kidstoreBD;

-- Tabela Produto (Brinquedos e Livros Infantis)
CREATE TABLE Produto (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nome VARCHAR(100) NOT NULL,
    preco DOUBLE NOT NULL,
    categoria ENUM('Brinquedo', 'Livro') NOT NULL,
    faixa_etaria VARCHAR(50) NOT NULL, -- Ex: "3-5 anos", "6-8 anos", "9-12 anos"
    descricao TEXT,
